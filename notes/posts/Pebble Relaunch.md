...
![](https://i.imgur.com/JABkbpj.png)
*The "It's still time" refers back to Pebble's old slogan of "It's time"*

The box contains the watch itself (with a 1.26" eink display) and a charger dongle, which converts from a USB-C cable to [Pebble's own charge connector][charger].
...
Pairing the watch with the app on the phone is simple enough, and then you can...

![](https://i.imgur.com/V0FmXmn.png)

As both Eric and my wife pointed out: I had one of the straps attached the wrong way around, as that little metal blob should be on the inside.

![](https://i.imgur.com/Cc6XWzD.png)

As you'd expect from an e-ink screen, it holds up really well in even bright sunlight. What I didn't expect from the e-ink screen though is how much animation Pebble OS shows, such as in this beautiful watchface:

![](https://i.imgur.com/sjLdcKh.gif)\
*See: now the metal nob is hidden on the inside*
...
So far, I've had to charge the watch once after about 4 days. That's a bit sooner than expected, but there are two likely reasons:
...
[ericmigi]: https://ericmigi.com/
[relaunch]: https://ericmigi.com/blog/introducing-two-new-pebbleos-watches
[repebble]: https://repebble.com/
[charger]: https://www.theverge.com/news/654440/eric-migicovsky-pebble-usb-charger-smartwatch-core-2-duo
[androidapp]: https://play.google.com/store/apps/details?id=coredevices.coreapp&hl=en_US
[iosapp]: https://apps.apple.com/us/app/pebble-core/id6743771967