...
alsoOn: 
 - https://bsky.app/profile/puf.io/post/3mjv73i2oob2e
 - https://x.com/puf/status/2046021057996275796
 - https://www.threads.com/@frankpuf/post/DXVUhaJCWeO
 - https://c.im/@puf/116434167945088220
 - https://www.linkedin.com/feed/update/urn:li:activity:7455700132345479168/
tags: [flutter, flutter-web, web, ai, mobile-deployment, mobile-apps, app-store, play-store]
summary: "Flutter web is not just a way to build web apps, but a deployment strategy for getting your mobile Flutter apps into the hands of users without the friction of app store distribution. Read the full article to learn more."
---
