...
If you've ever made it to the western end of Fisherman's Wharf (Ghirardelli Square) in San Francisco, you've undoubtedly seen this unusually shaped building at the head of the [Aquatic Park][app].

![outside pic from the north](https://i.imgur.com/L3xWKUH.png)
...
![outside pic from the south](https://i.imgur.com/EsqK1vd.png)
...
![pic of entrance](https://i.imgur.com/AHSePLx.png)
...
![ground floor overview](https://i.imgur.com/DqQSn1r.png)\
...
![A day in the life of storeship Niantic at Clay street wharf diorama and sign](https://i.imgur.com/kBq3MML.png)
...
![clipper model](https://i.imgur.com/jMjIdP8.png)

I couldn't help but chuckle at the explanation below the ship model:

![signage for Clipper Mystique](https://i.imgur.com/IkyNacv.png)

Those cards you see at the bottom there are called Clipper Cards. Yes exactly, it turns out the Clipper card that is used to pay for public transport in San Francisco was named in honor of the speedy Clipper ships of yore ([source][clippername]). Even when the physical transport cards are becoming less common these days (with the tap-your-phone-to-pay model), it's fun to know where the Clipper Card name came from.

![close-up of Clipper Cards](https://i.imgur.com/SO9VpCk.png)
...
![map view](https://i.imgur.com/xdCh7l0.png)


### Japanese sailor

![](https://i.imgur.com/DDnczzm.png)
*[The wub](https://commons.wikimedia.org/wiki/File:Kenichi_Horie%27s_Mermaid_in_San_Francisco_Maritime_Museum_2023-07-20.jpg), [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0), via Wikimedia Commons*

On the right side of the ground floor doors you'll find an exhibit about Japanese sailor [Kenichi Horie][sailor], who in 1962 was the first known person to cross the Pacific Ocean non-stop at 23 - the youngest at the time. He made the trip in the other direction in 2022 aged 83, which also makes him the oldest person to have crossed the pacific in a solo voyage on a sailing vessel.
...
![merman over the stairs](https://i.imgur.com/aaq6I2A.png)
...
![green mosaic](https://i.imgur.com/jwtviIx.png)
...
![sculpture](https://i.imgur.com/mIllQ8r.png)
...
![screen paintings](https://i.imgur.com/3cM1yzL.png)
...
![alcatraz](https://i.imgur.com/kVtNzLz.png)
...
![deck](https://i.imgur.com/lIEInnQ.png)
...
![radio exhibit](https://i.imgur.com/QrZVaEC.png)

### A palace for the people

On the eastern side of the top floor is the final small exhibit area we visited.

![a palace for the people exhibit](https://i.imgur.com/gbeZzTG.png)
...
![plaque with pics](https://i.imgur.com/vNnOxGk.png)
...
![schematic drawing](https://i.imgur.com/saG2WcJ.png)
...
![building seen from the north](https://i.imgur.com/m9WG9zS.png)
...
[app]: https://aquaticparkpier.org/aquatic-park-pier
[clippername]: https://en.wikipedia.org/wiki/Clipper_card#Renamed_to_Clipper
[sailor]: https://www.nps.gov/safr/learn/historyculture/kenichihorie.htm